...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
	...
	if (d >= radius)
		return fadeColor2;
	uint8_t redFill = fadeColor1.red - floor(d * fadeColor1.red / radius) + floor(d * fadeColor2.red / radius);
	uint8_t greenFill = fadeColor1.green - floor(d * fadeColor1.green / radius) + floor(d * fadeColor2.green / radius);
	uint8_t blueFill = fadeColor1.blue - floor(d * fadeColor1.blue / radius) + floor(d * fadeColor2.blue / radius);
	RGBAPixel color;
	color.red = redFill;
